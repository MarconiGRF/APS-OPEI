        ...
        <form @submit="requestRegisterDelegate">
            ...
            <div class="input-container email">
                ...
                <input
                    type="password"
                    v-model="ra"
                    v-on:input="onRAChange($event.target.value)"
                    placeholder="************"
                />
            </div>
            <div class="button-container">
                <input type="submit" value="Acessar" :disabled="isFormInvalid"/>
            </div>
...
export default {
    ...
    methods: {
        ...
        requestRegisterDelegate() {
            axios.post("http://localhost:5000/v2023/login/", {
                delegate: new Delegate(this.cpf, this.ra)
            })
                .then((response) => {
